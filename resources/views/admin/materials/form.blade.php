...
<label>{{ __('larena-content::admin.fields.slug') }}<input name="slug" value="{{ old('slug', $material?->currentSlug->value) }}" required pattern="[a-z0-9]+(?:-[a-z0-9]+)*" @disabled($material && !$canUpdate)></label>
